...
export const experience = [
  {
    ...
    items: {
      es: [
        'Apoyo en la gestión y organización de documentación administrativa.',
        'Registro y actualización de información en bases de datos.',
        'Elaboración de reportes y control de archivos en Excel.',
        'Diseño y elaboración de fotochecks para el personal operativo.',
        'Atención y soporte administrativo a clientes y personal interno.',
        'Digitalización, gestión y archivo de documentación física y digital.',
      ],
      en: [
        'Support in the management and organization of administrative documentation.',
        'Data entry and updates in databases.',
        'Preparation of reports and file control using Excel.',
        'Design and creation of ID badges for operational staff.',
        'Administrative assistance and support for clients and internal staff.',
        'Digitization, management, and archiving of physical and digital documentation.',
      ],
    },
  },
  {
